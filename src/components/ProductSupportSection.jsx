...
// components/ProductSupportSection.jsx
export default function ProductSupportSection() {
  return (
    <section className="bg-white px-4 sm:px-8 md:px-16 py-12 md:py-16">
      <div className="max-w-4xl mx-auto">
        <div className="bg-gray-50 p-6 md:p-8 rounded-lg">
          <h3 className="text-xl font-semibold text-gray-800 mb-6"></h3>
